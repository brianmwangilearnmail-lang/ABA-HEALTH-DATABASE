            ...
            {isSuccess ? (
                <div className="h-full flex flex-col items-center justify-center p-8 text-center bg-white space-y-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-gray-500 font-medium text-sm">Thank you for starting your wellness journey with Quins Center.</p>
                    </div>
                    <div className="w-full h-px bg-gray-100" />
                    <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest leading-relaxed">
                        A confirmation email has been sent to your registered address. Your premium selection is being prepared by our specialists.
                    </p>
                    <button 
                        onClick={handleClose}
